...
use cosmwasm_std::{
    to_binary, Binary, BlockInfo, CosmosMsg, Deps, DepsMut, Env, MessageInfo, Order, Response,
    StdResult,
};
...
const CONTRACT_NAME: &str = "crates.io:cw3-fixed-multisig-archway";
...
pub fn execute_withdrawal_rewards(
    _deps: DepsMut,
    _env: Env,
    info: MessageInfo,
    record_ids: Vec<u64>,
    ...
    // rewards from gas fees and premiums that go to this contract will be withdrawn to this contract native asset balance
    Ok(Response::new()
        .add_message(CosmosMsg::Custom(ArchwayMsg::WithdrawRewards {
            records_limit,
            record_ids,
        }))
...
mod tests {
    ...
    use cosmwasm_std::{coin, from_binary, BankMsg, Decimal, Empty};
