...
impl DepositInfo {
    ...
    pub fn get_take_deposit_messages(
        ...
        depositor: &Addr,
        contract: &Addr,
    ) -> StdResult<Vec<CosmosMsg<ArchwayMsg>>> {
        let take_deposit_msg: Vec<CosmosMsg<ArchwayMsg>> = if let DepositInfo {
            amount,
    ...
    pub fn get_return_deposit_message(&self, depositor: &Addr) -> StdResult<CosmosMsg<ArchwayMsg>> {
